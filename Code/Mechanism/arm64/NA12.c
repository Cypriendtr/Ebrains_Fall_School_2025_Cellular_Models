...
#define btau _p[4]
#define btau_columnindex 4
#define ainf _p[5]
#define ainf_columnindex 5
#define binf _p[6]
#define binf_columnindex 6
#define a _p[7]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "a_tau_Na12", _hoc_a_tau,
 "a_inf_Na12", _hoc_a_inf,
 "b_tau_Na12", _hoc_b_tau,
 "b_inf_Na12", _hoc_b_inf,
 "rates_Na12", _hoc_rates,
 0, 0
};
#define a_tau a_tau_Na12
#define a_inf a_inf_Na12
#define b_tau b_tau_Na12
#define b_inf b_inf_Na12
...
#define Vmid_ina Vmid_ina_Na12
 double Vmid_ina = -50;
#define Vmid_ac Vmid_ac_Na12
 double Vmid_ac = -28;
#define h h_Na12
 double h = 1;
#define k_ina k_ina_Na12
 double k_ina = -10;
#define k_ac k_ac_Na12
 double k_ac = 8;
#define m m_Na12
 double m = 3;
#define q10 q10_Na12
 ...
 "Vmid_ac_Na12", &Vmid_ac_Na12,
 "k_ac_Na12", &k_ac_Na12,
 "k_ina_Na12", &k_ina_Na12,
 "Vmid_ina_Na12", &Vmid_ina_Na12,
 "m_Na12", &m_Na12,
 "h_Na12", &h_Na12,
 "q10_Na12", &q10_Na12,
 0,0
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Na12 /Users/cyprien/Desktop/EBrains_2025/Code/Mechanism/NA12.mod\n");
...
double a_tau ( _threadargsprotocomma_ double _lV ) {
   double _la_tau;
  _la_tau = 0.01 + ( 0.33 / ( 1.0 + pow( ( ( _lV + 20.0 ) / 30.0 ) , 2.0 ) ) ) ;
...
double b_tau ( _threadargsprotocomma_ double _lV ) {
   double _lb_tau;
  _lb_tau = 0.7 + ( 16.0 / ( 1.0 + pow( ( ( _lV + 50.0 ) / 8.0 ) , 2.0 ) ) ) ;
...
static int  rates ( _threadargsprotocomma_ double _lV ) {
  ...
  _lqt = pow( q10 , ( ( celsius - 24.0 ) / 10.0 ) ) ;
    atau = a_tau ( _threadargscomma_ _lV ) / _lqt ;
   ainf = a_inf ( _threadargscomma_ _lV ) ;
   btau = b_tau ( _threadargscomma_ _lV ) / _lqt ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/cyprien/Desktop/EBrains_2025/Code/Mechanism/NA12.mod";
static const char* nmodl_file_text = 
  "COMMENT \n"
  "\n"
