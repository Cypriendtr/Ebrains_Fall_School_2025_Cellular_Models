...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "a_tau_kdrDA", _hoc_a_tau,
 "a_inf_kdrDA", _hoc_a_inf,
 "rates_kdrDA", _hoc_rates,
 0, 0
};
#define a_tau a_tau_kdrDA
#define a_inf a_inf_kdrDA
 extern double a_tau( _threadargsprotocomma_ double );
 extern double a_inf( _threadargsprotocomma_ double );
 /* declare global and static user variables */
#define Vmid_ac Vmid_ac_kdrDA
 double Vmid_ac = -30;
#define k_ac k_ac_kdrDA
 double k_ac = 9;
#define n n_kdrDA
 double n = 4;
#define q10 q10_kdrDA
 double q10 = 1.5;
#define tau_act tau_act_kdrDA
 double tau_act = 4;
 ...
 "Vmid_ac_kdrDA", &Vmid_ac_kdrDA,
 "k_ac_kdrDA", &k_ac_kdrDA,
 "n_kdrDA", &n_kdrDA,
 "tau_act_kdrDA", &tau_act_kdrDA,
 "q10_kdrDA", &q10_kdrDA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdrDA /Users/cyprien/Desktop/EBrains_2025/Code/Mechanism/KVDRNTS.mod\n");
...
double a_tau ( _threadargsprotocomma_ double _lV ) {
   double _la_tau;
  _la_tau = ( tau_act * exp ( - ( 0.000729 ) * ( pow( ( _lV + 32.0 ) , 2.0 ) ) ) ) + 4.0 ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/cyprien/Desktop/EBrains_2025/Code/Mechanism/KVDRNTS.mod";
static const char* nmodl_file_text = 
  "COMMENT \n"
  "\n"
