...
#define _f_settables _f_settables__CAV13 
#define settables settables__CAV13 
#define states states__CAV13 
...
#define qinf _p[5]
#define qinf_columnindex 5
#define qtau _p[6]
#define qtau_columnindex 6
#define eca _p[7]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "settables_CAV13", _hoc_settables,
 0, 0
};
...
#define Vmid_ac Vmid_ac_CAV13
 double Vmid_ac = -31;
#define k_ac k_ac_CAV13
 double k_ac = 7;
#define usetable usetable_CAV13
 double usetable = 1;
 ...
 "Vmid_ac_CAV13", &Vmid_ac_CAV13,
 "k_ac_CAV13", &k_ac_CAV13,
 "usetable_CAV13", &usetable_CAV13,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 CAV13 /Users/cyprien/Desktop/EBrains_2025/Code/Mechanism/CAV13.mod\n");
...
static int _reset;
static char *modelname = "calcium lVA channels for DA";
...
static int  _f_settables ( _threadargsprotocomma_ double _lv ) {
   qinf = 1.0 / ( 1.0 + exp ( ( Vmid_ac - _lv ) / k_ac ) ) ;
   qtau = 1.0 / ( ( - 0.20876 * ( _lv + 39.26 ) / ( exp ( - ( _lv + 39.26 ) / 4.111 ) - 1.0 ) + ( 0.9444 * exp ( - ( _lv + 15.38 ) / 224.1 ) ) ) ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/cyprien/Desktop/EBrains_2025/Code/Mechanism/CAV13.mod";
static const char* nmodl_file_text = 
