...
#define k_half _p[1]
#define k_half_columnindex 1
#define ik _p[2]
#define ik_columnindex 2
#define oinf _p[3]
#define oinf_columnindex 3
#define g _p[4]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 kca /Users/cyprien/Desktop/EBrains_2025/Code/Mechanism/kca_callaway.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Calcium dependent potassium channel (small conductance SK) from callaway (2000)";
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   oinf = pow( ( cai ) , 4.0 ) / ( pow( ( cai ) , 4.0 ) + ( pow( k_half , 4.0 ) ) ) ;
   g = gbar * oinf ;
   ik = ( 0.0001 ) * g * ( v - ek ) ;
   }
 _current += ik;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/cyprien/Desktop/EBrains_2025/Code/Mechanism/kca_callaway.mod";
static const char* nmodl_file_text = 
