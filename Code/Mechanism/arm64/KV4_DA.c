...
#define nrn_init _nrn_init__kaDa
#define _nrn_initial _nrn_initial__kaDa
#define nrn_cur _nrn_cur__kaDa
#define _nrn_current _nrn_current__kaDa
#define nrn_jacob _nrn_jacob__kaDa
#define nrn_state _nrn_state__kaDa
#define _net_receive _net_receive__kaDa 
#define rates rates__kaDa 
#define states states__kaDa 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kaDa", _hoc_setdata,
 "a_tau_kaDa", _hoc_a_tau,
 "a_inf_kaDa", _hoc_a_inf,
 "b_tau_kaDa", _hoc_b_tau,
 "b_inf_kaDa", _hoc_b_inf,
 "rates_kaDa", _hoc_rates,
 0, 0
};
#define a_tau a_tau_kaDa
#define a_inf a_inf_kaDa
#define b_tau b_tau_kaDa
#define b_inf b_inf_kaDa
...
#define Vshift Vshift_kaDa
 double Vshift = -80;
#define Vmid_ina Vmid_ina_kaDa
 double Vmid_ina = -85;
#define Vmid_ac Vmid_ac_kaDa
 double Vmid_ac = -30;
#define h h_kaDa
 double h = 1;
#define k_ina k_ina_kaDa
 double k_ina = -7;
#define k_ac k_ac_kaDa
 double k_ac = 7;
#define m m_kaDa
 double m = 1;
 ...
 "Vmid_ac_kaDa", &Vmid_ac_kaDa,
 "k_ac_kaDa", &k_ac_kaDa,
 "Vmid_ina_kaDa", &Vmid_ina_kaDa,
 "k_ina_kaDa", &k_ina_kaDa,
 "Vshift_kaDa", &Vshift_kaDa,
 "m_kaDa", &m_kaDa,
 "h_kaDa", &h_kaDa,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kaDa /Users/cyprien/Desktop/EBrains_2025/Code/Mechanism/KV4_DA.mod\n");
...
double b_tau ( _threadargsprotocomma_ double _lV ) {
   double _lb_tau;
  _lb_tau = taurecov + ( 32.41 + ( 78.4 / ( 1.0 + exp ( _lV + 68.5 ) / 5.95 ) ) - taurecov ) / ( 1.0 + exp ( ( - _lV + Vshift ) * 5.0 ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/cyprien/Desktop/EBrains_2025/Code/Mechanism/KV4_DA.mod";
static const char* nmodl_file_text = 
  "COMMENT \n"
  "\n"
  ...
  "UNITSOFF\n"
  "\n"
  "  b_tau = taurecov + (32.41+(78.4/(1+exp(V+68.5)/5.95))-taurecov)/(1+exp((-V+Vshift)*5))\n"
  " : fast inactivation  \n"
  "\n"
  "\n"
  "UNITSON \n"
